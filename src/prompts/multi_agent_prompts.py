...
validator_prompt = """
Your task is to validate the translated Python code by checking if it has any syntax errors or compilation issues.
...
YOU FIRST GENERATE A MAXIMUM OF 10 UNIT TEST METHODS FOR BOTH CODES.
