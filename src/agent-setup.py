...
from prompts.syntax_checker_agent_prompts import syntax_validator_prompt_1
from prompts.semantic_validator_agent_prompts import semantic_validator_prompt_1
...
syntactic_fixer = AssistantAgent(
    name="Code_Translator",
    system_message=syntax_validator_prompt_1,
    llm_config={"config_list": config_list}
)
...
semantic_fixer = AssistantAgent(
    name="Semantic_Fixer",
    system_message=semantic_validator_prompt_1,
    llm_config={"config_list": config_list}
)
...
#     system_message="""
#     "You are a Manager. 
#     You oversee the workflow, assign tasks to agents, and ensure the final code meets the requirements.",
#     """
#     llm_config={"config_list": config_list}
# )
...
groupchat = GroupChat(
    agents=[requirement_engineer, code_translator, syntactic_fixer, semantic_fixer, critic],
    messages=[],
    max_round=20,
